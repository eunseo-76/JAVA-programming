...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 특정 상수 값만 Set에 추가 */
        EnumSet<FoodsEnum> foods2 = EnumSet.of(FoodsEnum.DRINK_WOOLUCK_SMOOTHIEE, FoodsEnum.MEAL_BUNGEOPPANG_SUSHI);

        /* 특정 상수 값만 제외하고 Set에 추가 */
        EnumSet<FoodsEnum> food3
                = EnumSet.complementOf(EnumSet.of(FoodsEnum.DRINK_WOOLUCK_SMOOTHIEE, FoodsEnum.MEAL_BUNGEOPPANG_SUSHI));
    }
}
